# To study the relationship between average global temperature and several other factors.
...
**Temp**
the differece in degrees Celsius between the average global temperature in that period and a reference value. 
